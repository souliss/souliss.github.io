...
This article tries to be more than just a tutorial, it attempts to be a 'Goodies Bag' offering other helpful nuggets.
...
Solder a +3v3 connecting wire to the inboard (+) leg of capacitor C11 on the Mains board. Trim the loose end to length, bare the end, and insert into the replacement wifi board where shown below as the board is slid onto the Mains board, then solder the wire in place.
