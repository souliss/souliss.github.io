...
Copy the default cfg files to add your personal settings:
...
Add your souliss items using the syntax `{souliss=<Typical>:<nodeID>:<slot>:[<bit>]}` as detailed described in the howto guide [here](https://github.com/souliss/souliss/wiki/openHAB-Binding)
