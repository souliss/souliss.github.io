...
Follow [this guide](http://www.instructables.com/id/OpenHAB-on-Raspberry-Pi/step2/Configuring-openHAB-to-Start-Automatically-at-Boot/).
If you have any trouble in copying and pasting the init.d script from the web you can download it from [here](http://souliss.github.io/_posts/media/openhab).
