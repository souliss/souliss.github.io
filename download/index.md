---
layout: article
title: "Download Souliss"
date: 2015-06-12T13:57:25-04:00
modified:
excerpt:
...
Souliss is a [community](https://github.com/souliss/souliss/wiki/Community) driven open source project. You can use it in your home or products according to the [license]({{ site.url }}/terms/).

{% include toc.html %}

## Installation

If you are used with the Arduino world use Souliss will be straightforward, you can have a general [overview]({{ site.url }}/welcome/) and get [detailed](https://github.com/souliss/souliss/wiki) documentation.
